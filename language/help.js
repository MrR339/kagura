...
exports.list = (pushname) => {
	return`Halo kak ${pushname}, silahkan dipilih list menu bot dibawah ini, harap kasih jeda 5 detik sebelum menggunakan fitur lainnya agar ridak terjadi eror atau hal lain yg tidak di ingin kan.`
}
//—————「 Welcome 」—————//
exports.welcome = () => {
	return`Welcome
